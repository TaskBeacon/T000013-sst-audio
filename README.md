...
| `pre_stop_go_window` | pre stop go window stage in `src/run_trial.py` responder context. |
| `stop_signal_window` | stop signal window stage in `src/run_trial.py` responder context. |
